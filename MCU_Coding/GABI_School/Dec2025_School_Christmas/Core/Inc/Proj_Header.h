...
#define SONG_LOOP 		2			//Min 1
#define MOTOR_WAIT 		1000	//Min 500
...
typedef struct
{	
	uint32_t 	Timer_Inc, DF_STOP, DF_REPEAT; 
	uint32_t	Motor_Wait_Inc, Motor_Step_Inc;
} GABI_TIMER11_STRUCTURE;
extern GABI_TIMER11_STRUCTURE Tim11;

typedef struct
{	
	uint8_t 	Loop_song, Motor_Step, Song_Play_Status, Motor_status; 
