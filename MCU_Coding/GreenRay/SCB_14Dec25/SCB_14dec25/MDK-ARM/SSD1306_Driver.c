...
{
	if(i)
		SSD1306_WRITECOMMAND (SSD1306_INVERTDISPLAY); //SSD1306_INVERTDISPLAY
	else
		SSD1306_WRITECOMMAND (SSD1306_NORMALDISPLAY); //SSD1306_NORMALDISPLAY
}
...
uint8_t SSD1306_Init(void)
{
	...
	SSD1306_WRITECOMMAND(0xff); // Max Brightness 0xFF, Min Brightness 0x00

	//SSD1306_WRITECOMMAND(0xA7); //--set Inverted display (White BackGround)
	SSD1306_WRITECOMMAND(0xA6); 	//--set normal display	(Black BackGround)
